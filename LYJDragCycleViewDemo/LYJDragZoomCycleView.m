...
@interface LYJDragZoomCycleView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation LYJDragZoomCycleView
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[LYJZoomCycleViewCell class] forCellWithReuseIdentifier:kCellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    LYJZoomCycleViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kCellID forIndexPath:indexPath];
