...
#import "LYJDragZoomCycleView.h"
#import "GKFadeNavigationController.h"

@interface LYJSecondViewController ()<UITableViewDelegate, UITableViewDataSource,GKFadeNavigationControllerDelegate,YLDroagViewDelegate>
@property(nonatomic, strong) LYJDragZoomCycleView *dragView;
@property(nonatomic, strong) UITableView *tableView;
@property (nonatomic) GKFadeNavigationControllerNavigationBarVisibility navigationBarVisibility;
@end

@implementation LYJSecondViewController
...
- (void)setupUI {
    ...
    //创建轮播图
    self.dragView = [[LYJDragZoomCycleView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, kHeaderHeight) andDataSource:[self getimageSource] autoScroll:YES scrollInterval:2];
